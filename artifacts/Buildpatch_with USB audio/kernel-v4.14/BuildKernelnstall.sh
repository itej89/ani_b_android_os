...
INSTALL_PATH=${INSTALL_ROOT} INSTALL_MOD_PATH=${INSTALL_ROOT} ARCH=arm64 make -j16

INSTALL_PATH=${INSTALL_ROOT} INSTALL_MOD_PATH=${INSTALL_ROOT} ARCH=arm64 make  dtbs -j16
